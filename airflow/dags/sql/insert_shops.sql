INSERT INTO public.shops (shop_id, shop_name, shop_function)
VALUES
(1, 'jahwaggysrecords', 'scrap_jahwaggysrecords'),
(2, 'onlyrootsreggae', 'scrap_onlyrootsreggae'),
(3, 'controltower', 'scrap_controltower'),
(4, 'reggaefever', 'scrap_reggaefever'),
(5, 'pataterecords', 'scrap_pataterecords'),
(6, 'toolboxrecords', 'scrap_toolboxrecords'),
(7, 'lionvibes', 'scrap_lionvibes'),
(8, 'reggaemuseum', 'scrap_reggaemuseum');
...
(6, 'https://www.toolboxrecords.com/fr/catalog/3/dub-ragga/#page='),
-- lionvibes links
(7, 'https://www.lionvibes.com/collections/new-records?filter.p.m.custom.format=7%22&page=X&sort_by=created-descending'),
(7, 'https://www.lionvibes.com/collections/new-records?filter.p.m.custom.format=10%22&page=X&sort_by=created-descending'),
(7, 'https://www.lionvibes.com/collections/new-records?filter.p.m.custom.format=12%22&page=X&sort_by=created-descending'),
(7, 'https://www.lionvibes.com/collections/new-records?filter.p.m.custom.format=LP&page=X&sort_by=created-descending'),
-- reggaemuseum links
