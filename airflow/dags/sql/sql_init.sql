...
CREATE TABLE IF NOT EXISTS public.vinyls (
    ...
    vinyl_title character varying(300),
    vinyl_image character varying(300),
    vinyl_price integer,
    vinyl_currency character varying(5),
    vinyl_reference character varying(300),
    vinyl_link character varying(300),
...
CREATE TABLE IF NOT EXISTS public.songs (
    song_id serial,
    vinyl_id integer NOT NULL,
    song_title character varying(700),
    song_mp3 character varying(300),
    PRIMARY KEY (song_id)
);
